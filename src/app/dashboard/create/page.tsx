        ...
        {!isLoading && blogData && (
          <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex justify-center space-x-4 pt-8">
              ...
              <button className="px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white rounded-lg transition-all duration-300 font-medium shadow-lg">
                Publish Blog
              </button>
            </div>
          </div>

...
const buzzwords = ["SEO-Ready", "AI-Powered", "Unique", "Effortless"]
...
function AnimatedHeadline() {
  ...
  return (
    <motion.h1
      className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 text-center md:text-left leading-tight mb-4"
...
function FeatureIcon({ icon: Icon, label, x, y, delay }: Feature) {
  return (
    <motion.div
      className="absolute bg-white/90 border border-gray-200 backdrop-blur-md shadow-xl rounded-xl px-3 py-2 flex items-center gap-2 text-sm font-medium text-gray-800 z-10"
      style={{ left: x, top: y }}
...
export default function Home() {
  ...
  return (
    <main id="hero" className="min-h-screen flex flex-col items-center justify-center px-6 py-30 scroll-mt-28">
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 text-center md:text-left">
          ...
          <motion.p
            className="text-gray-600 text-lg md:text-xl font-body max-w-xl mx-auto md:mx-0 leading-relaxed"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <motion.div
          className="relative h-[520px] w-full md:w-[640px] mx-auto"
      ...
      >
        <div className="flex flex-col items-center mt-3 text-sm text-gray-500 animate-bounce sm:flex">
